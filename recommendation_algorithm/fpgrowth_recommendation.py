...
min_support = max(1 / len(transactions), 0.1)  # at least 10% or 1 transaction
frequent_itemsets = fpgrowth(df_encoded, min_support=min_support, use_colnames=True)

# Step 4: Association Rules
# Use low confidence threshold to allow more recommendations
...
def recommend(Item_Name, top_n=3, sort_by="confidence"):
    ...
    # If item has no rule, fallback: recommend most frequent co-occurring items
